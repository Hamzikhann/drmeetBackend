	...
	return (
		<footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
			<div className="gap-6 justify-between md:flex">
				<div className="flex-1">
					<div className="max-w-xs">
						{/* <img src="" alt="DoctorMeet" className="w-32" /> */}
						<p className="xl:text-3xl text-2xl text-center text-blue-400 mb-4  font-lobster italic">Doctor Meet</p>
						<p className="leading-relaxed mt-2 text-[15px]">
							Book appointments with the best Doctors and Specialists such as Gynecologists, Skin Specialists, Child
			...
			<div className="mt-8 py-6 border-t items-center justify-between sm:flex">
				<div className="mt-4 sm:mt-0">&copy; 2022 Doctor Meet All rights reserved.</div>
